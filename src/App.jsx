...
const App = () => {
    ...
    */
    ...
    return (
        <div className="h-screen bg-[#E5DDD5] font-[Inter] antialiased flex flex-col">
            ...
            {isLoggedIn && (
                ...
                <header className="flex items-center p-4 bg-[#075E54] border-b border-gray-200 shadow-md flex-shrink-0">
                <button
            ...
            <div className="flex-1 p-4 overflow-y-auto space-y-4 pb-4 scroll-smooth">
                <style jsx>{`
            ...
            <div className="p-4 bg-[#F0F0F0] border-t border-gray-300 flex-shrink-0">
